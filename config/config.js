...
//
nconf.argv()
    .env(['PORT','NODE_ENV'])// Load select environment variables
    .defaults({store:{
            NODE_ENV:'development'
    }});
var envConfigPath = rootPath + '/config/env/'+nconf.get('NODE_ENV')+'.json1';
try{
...
nconf.file(nconf.get('NODE_ENV'),{ file: envConfigPath, type:'file', format:json5 })
    .file('shared',{ file: rootPath+ '/config/env/all.json1', type:'file', format:json5 })
